...
// The reading face. Optical sizing is left on so titles set light and
// prose set small come from the same family without looking alike.
...
// the .dark class it sets is what every token in globals.css keys off.
